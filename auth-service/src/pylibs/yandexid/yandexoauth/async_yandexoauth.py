...
class AsyncYandexOAuth:
    ...
    def __init__(
        ...
        self.__client = client or AsyncClient(base_url=self.BASE_URL, params=self.__params, headers=self.__headers)
    ...
    async def get_token_from_code(
        self, code: str, device_id: str | None = None, device_name: str | None = None
    ) -> Token:
        """Get token from code
